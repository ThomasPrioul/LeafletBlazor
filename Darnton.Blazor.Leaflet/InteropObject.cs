...
{
    /// <summary> Abstract base class for types that represent JavaScript objects. </summary>
    public abstract class InteropObject : IAsyncDisposable
    {
        /// <summary> The JavaScript binder used to talk to the interop layer. </summary>
        internal LeafletMapJSBinder JSBinder;

        /// <summary> The JavaScript runtime object reference. </summary>
        internal IJSObjectReference JSObjectReference;

        /// <summary>
        /// Creates the JavaScript object, stores a reference to it and the JavaScript runtime
        ...
        public async Task BindJsObjectReference(LeafletMapJSBinder jsBinder)
        {
            JSBinder = jsBinder;
        ...
        /// </summary>
        /// <param name="nullBindingMessage">
        /// The error message to be used when an exception is thrown.
        /// </param>
        ...
        /// <summary> Creates the JavaScript object </summary>
